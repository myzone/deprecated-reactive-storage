...
public class ImmutableRemoteDataObjects extends UtilityClass {
    ...
    public static @Immutable class ImmutableRemotePrimitive implements RemotePrimitive {
        ...
        public boolean equals(Object o) {
            if (this == o)
                return true;
            if (!(o instanceof RemotePrimitive))
                return false;

            RemotePrimitive that = (RemotePrimitive) o;

            if (!collectionName.equals(that.getCollectionName()))
                return false;
        ...
        @Override public String toString() {
            return Objects.toStringHelper(this).add("collectionName", collectionName).add("data", data).toString();
        }
    ...
    public static @Immutable class ImmutableRemoteValue implements RemoteValue {
        ...
        public boolean equals(Object o) {
            ...
            if (!collectionName.equals(that.getCollectionName()))
                return false;
            if (!fields.equals(that.getFields()))
                return false;
        ...
        public String toString() {
            return Objects.toStringHelper(this).add("collectionName", collectionName).add("fields", fields).toString();
        }
    ...
    public static @Immutable class ImmutableRemoteReference implements RemoteDataObject.RemoteReference {
        ...
        @Override
        public String toString() {
            return Objects.toStringHelper(this).add("collectionName", collectionName).add("id", id).toString();
        }
